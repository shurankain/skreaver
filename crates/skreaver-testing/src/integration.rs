...
use skreaver_http::runtime::HttpAgentRuntime;
...
pub mod test_utils {
    ...
    impl Agent for TestAgent {
        ...
        fn memory_reader(&self) -> &dyn skreaver_core::MemoryReader {
            &self.memory
        }

        fn memory_writer(&mut self) -> &mut dyn skreaver_core::MemoryWriter {
            &mut self.memory
        }
    }
}
